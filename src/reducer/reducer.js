  ...
  games: [
    {
      ...
      count: 1,
      src:
        "https://store.ubi.com/dw/image/v2/ABBS_PRD/on/demandware.static/-/Sites-masterCatalog/default/dwd01ab4a1/images/large/5efc463f0d253c1d3430ff98.jpg?sw=341&sh=450&sm=fit",
    },
    {
      name: "Metro Exodus",
      categories: "Action",
      ...
      count: 1,
      src:
        "https://cdn.cloudflare.steamstatic.com/steam/apps/412020/capsule_616x353.jpg?t=1600359844",
    },
    {
      name: "Hitman 3",
      categories: "Stealth",
      ...
      count: 1,
      src:
        "https://upload.wikimedia.org/wikipedia/ru/4/4b/Hitman_3_Packart.jpg",
    },
    {
      name: "Stronghold",
      categories: "Strategy",
      ...
      currPrice: 13,
      count: 1,
      src: "https://upload.wikimedia.org/wikipedia/ru/6/62/Strongholdcover.jpg",
    },
    {
      name: "Oblivion",
      categories: "RPG",
      ...
      currPrice: 20,
      count: 1,
      src: "https://i.playground.ru/e/pxmWb6GiPJCuvjtcJGvz1g.jpeg?600xauto",
    },
    {
      name: "Skyrim",
      categories: "RPG",
      ...
      count: 1,
      src:
        "https://cdn.dlcompare.com/game_tetiere/img/elderscrolls5skyrim_img4.jpg",
    },
    {
      name: "Казаки 3",
      categories: "Strategy",
      ...
      count: 1,
      src:
        "https://upload.wikimedia.org/wikipedia/ru/0/08/%D0%9A%D0%B0%D0%B7%D0%B0%D0%BA%D0%B8_3.jpg",
    },
    {
      name: "Blacklist",
      categories: "Stealth",
      ...
      count: 1,
      src:
        "https://upload.wikimedia.org/wikipedia/ru/4/4e/Splinter_Cell_Blacklist_PC.jpeg",
    },
  ],
  basket: [],
  totalPrice: 0,
...
const updateItem = (newCurrentGame, basket, id) => {
  if (newCurrentGame.count === 0) {
    return [...basket.slice(0, id), ...basket.slice(id + 1)];
  }

  if (id === -1) {
    return [...basket, newCurrentGame];
  }

  return [...basket.slice(0, id), newCurrentGame, ...basket.slice(id + 1)];
};
...
const reducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case "ADD_TO_BASKET":
      if (
        !!state.basket.find(
          (game) => game.name === currentGameAdd(state, action.id).name
        )
      ) {
        toast.configure({});
      ...
      return {
        ...state,
        basket: newArr,
        totalPrice: state.totalPrice + currentGameAdd(state, action.id).price,
      };
    ...
    case "DEL_FROM_BASKET":
      return {
        ...
        totalPrice:
          state.totalPrice - currentGameDel(state, action.id).currPrice,
      };
